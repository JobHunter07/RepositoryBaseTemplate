# PR Checklist for: feat: add Python dependency installation and requirements file

Python dependency installation and requirements file
...
- [ ] The change preserves or documents Airplane Mode requirements (local mocks, no runtime external deps for dev/tests).
